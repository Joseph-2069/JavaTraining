package jdbc_concur_updatable_resultset_works_with_derby_db;
...
public class MetaData {
	...
	//try(Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/restapi?useSSL=false","root","namrata");)
		try(Connection con=DriverManager.getConnection("jdbc:derby:josephdb;create=true;user=Joseph;password=Pass@1234");	)
		{
