...
public class CheckedExceptionEx_throws {
	...
	//handle or declare rule : either write try-catch or write throws 
//	it is unnecessary to write both try-catch and throws
//	no error will be thrown it just increases the time 
